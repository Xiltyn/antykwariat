<?php
/**
 * antykwariat functions and definitions
 *
...
if ( ! function_exists( 'bookstore_setup' ) ) :
	...
	function bookstore_setup() {
		 ...
		 * If you're building a theme based on antykwariat, use a find and replace
		...
		register_nav_menus( array(
			...
			'menu-2' => esc_html__( 'Secondary', 'bookstore_footer' ),
		) );
...
function bookstore_scripts() {
	...
	wp_enqueue_script( 'bookstore-main', get_template_directory_uri() . '/js/vendor.js', array(), '20151215', true );

	wp_enqueue_script( 'bookstore-main', get_template_directory_uri() . '/js/main.js', array(), '20151215', true );
